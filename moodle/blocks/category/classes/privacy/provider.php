...
class provider implements \core_privacy\local\metadata\provider, \core_privacy\local\request\user_preference_provider {
    ...
    public static function get_metadata(\core_privacy\local\metadata\collection $collection) :
        ...
        $collection->add_user_preference('block_category_last_tab', 'privacy:metadata:overviewlasttab');
        return $collection;
    }
    ...
    public static function export_user_preferences(int $userid) {
        $preference = get_user_preferences('block_category_last_tab', null, $userid);
        if (isset($preference)) {
            \core_privacy\local\request\writer::export_user_preference('block_category', 'block_category_last_tab',
                    $preference, get_string('privacy:metadata:overviewlasttab', 'block_category'));
        }
    }
}
