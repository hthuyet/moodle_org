...
$string['category:addinstance'] = 'Add a new course overview block';
$string['category:myaddinstance'] = 'Add a new course overview block to Dashboard';
